...
class Supplier(models.Model):
    ...
    bad_remarks_count = models.PositiveIntegerField(default=0, null=True, blank=True)
    good_remarks_count = models.PositiveIntegerField(default=0, null=True, blank=True)
